# Perturbation applied: Boosting Language (`boosting_language`)

Rewrites existing sentences to use definitive markers ("certainly," "unmistakably," "establishes"), social proof (how widely a view is held), injunctive norms (what the community agrees should be done), and appeals to shared values (e.g. green AI). This technique is applied widely inside the given text.
