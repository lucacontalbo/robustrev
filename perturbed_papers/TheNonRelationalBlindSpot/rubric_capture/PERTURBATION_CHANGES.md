# Perturbation applied: Frame / Rubric Capture (`rubric_capture`)

Use the baseline review to identify which rubric axis the paper scored high on vs. low. Then add, in the given text snippet, a part strongly emphasizing the strong axis and strongly downplaying the weak axis (put it as a central claim). Leave the rest of the text unchanged. Do not mention anything about the baseline review.
